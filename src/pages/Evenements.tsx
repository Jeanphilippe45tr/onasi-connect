...
const evenements = [
  {
    ...
    heure: "7h30",
    lieu: "Collège ONASI",
    description: "Accueil des nouveaux et anciens élèves. Distribution des emplois du temps.",
    type: "Rentrée",
  },
  {
    ...
    description: "Présentation des résultats du premier trimestre et échanges avec les enseignants.",
    type: "Réunion",
  },
  {
    ...
    description: "Célébration de la diversité culturelle avec danses, chants et expositions.",
    type: "Culture",
  },
  {
    ...
    description: "Football, basketball, athlétisme et volleyball entre les différentes classes.",
    type: "Sport",
  },
  {
    ...
    description: "Cérémonie de remise des prix aux meilleurs élèves de l'année.",
    type: "Cérémonie",
  },
];
...
const calendrier = [
  ...
  { periode: "Congés de Noël", debut: "Décembre 2025", fin: "Janvier 2026", color: "bg-secondary" },
  { periode: "2ème Trimestre", debut: "Janvier 2026", fin: "Mars 2026", color: "bg-primary" },
  { periode: "Congés de Pâques", debut: "Mars 2026", fin: "Avril 2026", color: "bg-secondary" },
  { periode: "3ème Trimestre", debut: "Avril 2026", fin: "Juin 2026", color: "bg-primary" },
  { periode: "Examens officiels", debut: "Juin 2026", fin: "Juillet 2026", color: "bg-accent" },
  { periode: "Grandes vacances", debut: "Juillet 2026", fin: "Septembre 2026", color: "bg-secondary" },
];
