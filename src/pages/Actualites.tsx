...
const articles = [
  ...
  },
  {
    ...
    extrait: "Une journée riche en couleurs célébrant la diversité culturelle de notre établissement bilingue avec danses traditionnelles, chants et expositions artistiques.",
  },
  {
    titre: "Partenariat avec l'Université de Yaoundé",
    date: "Mai 2025",
    categorie: "Communiqué",
    extrait: "ONASI signe un accord de partenariat pour l'orientation et le suivi académique de nos meilleurs élèves vers les grandes universités.",
  },
  {
    titre: "Compétition inter-établissements de sciences",
    date: "Avril 2025",
    categorie: "Événements",
    extrait: "Nos élèves remportent le premier prix en physique et chimie lors du concours régional face à 15 établissements.",
  },
  {
    titre: "Rentrée scolaire 2025-2026",
    date: "Septembre 2025",
    categorie: "Communiqué",
    extrait: "Toutes les informations pratiques pour préparer la rentrée : dates, fournitures, inscriptions et orientation des nouveaux élèves.",
  },
  {
    titre: "Résultats GCE O/L et A/L 2025",
    date: "Août 2025",
    categorie: "Résultats",
    extrait: "Outstanding results at the GCE exams with a 92% pass rate for our anglophone students across all subjects.",
  },
  {
    titre: "Inauguration du laboratoire informatique",
    date: "Mars 2025",
    categorie: "Événements",
    extrait: "Le collège inaugure un nouveau laboratoire informatique équipé de 30 ordinateurs pour renforcer l'apprentissage numérique.",
  },
  {
    titre: "Tournoi de football inter-classes",
    date: "Février 2025",
    categorie: "Événements",
    extrait: "La classe de 3ème A remporte le tournoi annuel de football. Une compétition sportive qui renforce la cohésion entre élèves.",
  },
  {
    titre: "Atelier de formation des enseignants",
    date: "Janvier 2025",
    categorie: "Communiqué",
    extrait: "Session de renforcement des capacités pédagogiques pour nos enseignants, axée sur les nouvelles méthodes d'enseignement interactif.",
  },
  {
    titre: "Cérémonie de remise des prix 2024",
    date: "Juillet 2024",
    categorie: "Événements",
    extrait: "Les meilleurs élèves de l'année ont été récompensés lors d'une cérémonie solennelle en présence des parents et autorités locales.",
  },
  {
    titre: "Campagne de sensibilisation santé",
    date: "Novembre 2024",
    categorie: "Communiqué",
    extrait: "En partenariat avec le centre de santé d'Ebolowa, une campagne de sensibilisation sur l'hygiène et la prévention du paludisme.",
  },
  {
    titre: "Olympiades de mathématiques du Sud",
    date: "Décembre 2024",
    categorie: "Résultats",
    extrait: "Trois élèves d'ONASI se qualifient pour les Olympiades nationales de mathématiques après une brillante performance régionale.",
  },
];
